...
<body class="container">
    <br>
    <h2 style="text-align:center">Lista de Destinos</h2>
    <hr>
...
<style>
    ...
    <div class="row">
        <div class="card shadow">
            <div class="card-body">
                    <table class="table table-hover"  id="destino">
                <thead>
                    <tr>
                        <td class="position-relative px-5">ID</td>
                        <td class="position-relative px-5">Destino</td>
                ...
                <tbody class="table-group-divider">
                    @foreach ($destino as $destino)
                        <tr>
                            <td class="position-relative px-5">{{ $destino->id_destino }}</td>
                            <td class="position-relative px-5">{{ $destino->destino }}</td>
                            <td>
                                <!-- BOTON AZUL DE MODIFICAR -->
                                <a href="{{ route('destinoEdit',['id' => $destino->id_destino]) }}">
                                ...
                                <a href="{{ route('destinoShow',['id' => $destino->id_destino]) }}">
                                    <button type="button" class="btn btn-warning btn-sm">
                                        <span>Detalle</span>
                                    </button>
                                </a>
                                <!-- BOTON ROJO ELIMINAR -->
                                <a href="{{ route('destinoDel',['id' => $destino->id_destino]) }}">
